        ...
        {address && presaleInfo?.userBalance && (
          <div className="mt-4 p-3 bg-blue-50 rounded-lg">
            ...
            <div className="grid grid-cols-2 gap-2 text-xs">
              <div>BNB: {presaleInfo.userBalance.bnb}</div>
              <div>USDT: {presaleInfo.userBalance.usdt}</div>
              <div>USDC: {presaleInfo.userBalance.usdc}</div>
              <div>SCT: {presaleInfo.userBalance.tokens}</div>
            </div>
          </div>
        )}
      </div>
