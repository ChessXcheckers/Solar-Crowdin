  ...
  return (
    <div className="bg-white dark:bg-solar-dark rounded-lg shadow-lg p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {steps.map((step) => (
          <div key={step.step} className="text-center p-4 border border-gray-200 dark:border-solar-grey/20 rounded-lg hover:shadow-md dark:hover:bg-solar-navy/50 transition-all">
